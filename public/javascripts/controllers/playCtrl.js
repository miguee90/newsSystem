angular.module('globalmediaApp').controller('playCtrl', function ($scope,$timeout,$http, uiGmapGoogleMapApi,$state, $stateParams) {
	var camara=$stateParams.id;
	$scope.camaras={uno: false, dos: false, tres:false,cuatro:false, cinco:false, seis:false, siete:false, ocho:false, nueve:false, diez:false, once:false, doce:false};
	
	switch(camara){
		case '1':
			$scope.camaras={uno: true, dos: false, tres:false,cuatro:false, cinco:false, seis:false, siete:false, ocho:false, nueve:false, diez:false, once:false, doce:false};
		break;
		case '2':
			$scope.camaras={uno: false, dos: false, tres:false,cuatro:false, cinco:false, seis:false, siete:false, ocho:false, nueve:false, diez:false, once:false, doce:false};
		break;
		case '3':
			$scope.camaras={uno: false, dos: false, tres:true,cuatro:false, cinco:false, seis:false, siete:false, ocho:false, nueve:false, diez:false, once:false, doce:false};
		break;
		case '4':
			$scope.camaras={uno: false, dos: false, tres:false,cuatro:true, cinco:false, seis:false, siete:false, ocho:false, nueve:false, diez:false, once:false, doce:false};
		break;
		case '5':
			$scope.camaras={uno: false, dos: false, tres:false,cuatro:false, cinco:true, seis:false, siete:false, ocho:false, nueve:false, diez:false, once:false, doce:false};
		break;
		case '6':
			$scope.camaras={uno: false, dos: false, tres:false,cuatro:false, cinco:false, seis:true, siete:false, ocho:false, nueve:false, diez:false, once:false, doce:false};
		break;
		case '7':
			$scope.camaras={uno: false, dos: false, tres:false,cuatro:false, cinco:false, seis:false, siete:true, ocho:false, nueve:false, diez:false, once:false, doce:false};
		break;
		case '8':
			$scope.camaras={uno: false, dos: false, tres:false,cuatro:false, cinco:false, seis:false, siete:false, ocho:true, nueve:false, diez:false, once:false, doce:false};
		break;
		case '9':
			$scope.camaras={uno: false, dos: false, tres:false,cuatro:false, cinco:false, seis:false, siete:false, ocho:false, nueve:true, diez:false, once:false, doce:false};
		break;
		case '10':
			$scope.camaras={uno: false, dos: false, tres:false,cuatro:false, cinco:false, seis:false, siete:false, ocho:false, nueve:false, diez:true, once:false, doce:false};
		break;
		case '11':
			$scope.camaras={uno: false, dos: false, tres:false,cuatro:false, cinco:false, seis:false, siete:false, ocho:false, nueve:false, diez:false, once:true, doce:false};
		break;
		case '12':
			$scope.camaras={uno: false, dos: false, tres:false,cuatro:false, cinco:false, seis:false, siete:false, ocho:false, nueve:false, diez:false, once:false, doce:true};
		break;
	}

	var carousel = (function(){
		var container = document.getElementById("carrusel");
		var items = container.getElementsByTagName('ul')[0];
