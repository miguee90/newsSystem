angular.module('globalmediaApp').controller('noticiaCtrl', function ($scope,$timeout,$uibModal,$http,$stateParams,$sce, $location, $anchorScroll) {
	...
	/*LOAD INFO*/
	$http.get('nota/'+$scope.nota).then(function(respuesta){
		...
		$http.post('/plusHitNota', {id:$scope.completo.nota.idNotas}).then(function(h){
		}, function(err){
			console.error(err);
		});
