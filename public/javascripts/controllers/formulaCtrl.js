angular.module('globalmediaApp').controller('formulaCtrl', function ($scope,$timeout,$http) {
	var INTERVAL = 10000;
	...
	$http.post('/plusHitRecurso', {id:1003}).then(function(h){
		console.log("HITS");
		console.log(h);
	}, function(err){
		console.error(err);
	...
	$http.get('secciones/'+'SanLuis').then(function(response){
