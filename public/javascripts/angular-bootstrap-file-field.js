...
.directive('fileField', function() {
  return {
    ...
    template:'<button type="button"><ng-transclude></ng-transclude><input type="file" nv-file-select="" uploader="uploader" style="display:none" ngf-select required></button>',
    replace:true,
    transclude:true
  };
});